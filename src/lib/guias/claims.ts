...
export const LEGAL_CLAIMS: LegalClaim[] = [
  ...
  // As três âncoras seguintes estavam deslocadas. O texto das afirmações
  // estava substantivamente certo — era o ARTIGO citado que apontava para o
  // sítio errado, o que num sistema que se orgulha de citar o artigo exato é
  // pior do que âncora nenhuma: convida o leitor a confirmar onde não está e
  // a concluir que o guia se enganou no conteúdo.
  { id: "juros-de-mora.sem-interpelacao", guideId: "juros-de-mora", statement: "Os juros de mora vencem-se automaticamente, sem ser preciso enviar qualquer aviso ao devedor.", sourceIds: ["dl62_2013"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "high", nota: "Art. 7.º do DL 62/2013 («Juros de mora»). A nota anterior citava o Art. 4.º, n.º 2 — mas o Art. 4.º regula o PRAZO de pagamento (o n.º 3 fixa os 30 dias supletivos), pelo que o direito a juros sem interpelação não pode estar no mesmo artigo. Sinalizada para confirmação na revisão fiscal humana." },
  { id: "juros-de-mora.indemnizacao-40", guideId: "juros-de-mora", statement: "Além dos juros, o credor tem direito a um montante mínimo de 40 € a título de indemnização pelos custos de cobrança, também sem necessidade de interpelação.", sourceIds: ["dl62_2013"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", ruleKey: "INDEMNIZACAO_CUSTOS_COBRANCA", nota: "Art. 8.º, n.º 1 do DL 62/2013. A nota anterior citava o Art. 7.º, que é «Juros de mora» — a indemnização pelos custos de cobrança é o artigo seguinte. Sinalizada para confirmação na revisão fiscal humana." },
  // A9: o guia chama-se «Prazos de pagamento e juros de mora», explica quando
  // os juros nascem, explica que nascem sozinhos, explica os 40 € — e nunca
  // dizia a que taxa. A taxa comercial é SEMESTRAL (fixada por Aviso da
  // Entidade do Tesouro e Finanças em janeiro e julho), por isso vem do motor
  // com vigência declarada, não escrita no corpo do guia.
  { id: "juros-de-mora.taxa-transacoes-comerciais", guideId: "juros-de-mora", ruleKey: "JUROS_MORA.transacoesComerciais", statement: "Nas transações comerciais abrangidas pelo DL 62/2013, a taxa supletiva de juros de mora é de 10,15% no 1.º semestre de 2026.", sourceIds: ["avisoJuros2026"], appliesFrom: "2026-01-01", appliesUntil: "2026-06-30", confidence: "verified", reviewSeverity: "critical", nota: "Aviso n.º 822/2026/2, DR n.º 11 de 16-01-2026 (§ 5.º do Art. 102.º do Código Comercial). Fixada por semestre — `appliesUntil` obriga a reconfirmar em julho." },
  { id: "juros-de-mora.taxa-outros-comerciais", guideId: "juros-de-mora", ruleKey: "JUROS_MORA.outrosCreditosComerciais", statement: "Nos restantes créditos comerciais, fora do âmbito do DL 62/2013, a taxa supletiva é de 9,15% no 1.º semestre de 2026.", sourceIds: ["avisoJuros2026"], appliesFrom: "2026-01-01", appliesUntil: "2026-06-30", confidence: "verified", reviewSeverity: "critical", nota: "§ 3.º do Art. 102.º do Código Comercial, mesmo Aviso. A distinção é subtil e cara: quem cobra uma fatura B2B tem direito à taxa mais alta e aplica quase sempre a mais baixa." },
  { id: "juros-de-mora.taxa-civil", guideId: "juros-de-mora", ruleKey: "JUROS_MORA.civis", statement: "Nas obrigações civis — fora do comércio — a taxa de juros legais e de mora é de 4%.", sourceIds: ["portaria291_2003"], appliesFrom: DE, confidence: "verified", reviewSeverity: "high", nota: "Portaria n.º 291/2003. É também a taxa dos juros indemnizatórios devidos pela AT ao contribuinte." },
  // A10: a frase «com entidades públicas os prazos são, em regra, mais curtos»
  // estava trocada. O Art. 5.º fixa os MESMOS 30 dias; o que muda é a margem
  // de estipulação, não a duração.
  { id: "juros-de-mora.entidades-publicas", guideId: "juros-de-mora", statement: "Com entidades públicas o prazo supletivo de pagamento é o mesmo — 30 dias. O que muda não é a duração, é a margem de estipulação: o prazo não pode ser livremente alargado por acordo, e o teto de 60 dias só vale em casos tipificados na lei, designadamente entidades do setor da saúde.", sourceIds: ["dl62_2013"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "high", nota: "Art. 5.º do DL 62/2013. Dizer «mais curtos» levava o leitor a contar mal — e a contar mal um prazo de pagamento é perder juros a que tem direito." },
  ...
  // A13 — problema de aplicabilidade: o artigo exige créditos «evidenciados
  // como tal na contabilidade». Um independente no regime simplificado não
  // tem contabilidade organizada e, na prática, não usa este regime. O guia
  // estava categorizado como «Independentes» e nunca o dizia.
  { id: "recuperar-iva.aplicabilidade", guideId: "recuperar-iva-incobravel", statement: "O regime exige créditos evidenciados como tal na contabilidade. Quem está no regime simplificado não tem contabilidade organizada e, na prática, não consegue usar esta via — a recuperação do IVA incobrável é uma ferramenta de quem tem contabilidade organizada.", sourceIds: ["civa78a"], appliesFrom: DE, appliesTo: ["TI", "ENI", "COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 78.º-A, n.º 1 CIVA. O bloco final do guia já dizia «se estás isento, não há nada a recuperar» — faltava o segundo passo da mesma verificação." },
  { id: "recuperar-iva.dever-comunicar", guideId: "recuperar-iva-incobravel", statement: "O credor que regulariza o IVA a seu favor tem de comunicar a regularização ao devedor, para que este regularize a favor do Estado o imposto que deduziu.", sourceIds: ["civa78a", "civa78b"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "É uma obrigação que vem atrás do direito — dizer «o direito existe» sem a referir é contar meia história." },
  { id: "recuperar-iva.dever-reentregar", guideId: "recuperar-iva-incobravel", statement: "Se o crédito vier a ser recuperado, no todo ou em parte, o imposto regularizado tem de ser entregue de novo ao Estado.", sourceIds: ["civa78c"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 78.º-C CIVA." },
  ...
  // A14 — a tabela do guia deixava a célula «Conta-se de» por responder na
  // coluna da caducidade. A ironia é que o Art. 45.º, n.º 4 tem exatamente a
  // mesma fórmula do Art. 48.º, n.º 1: dizê-lo é mais curto do que o que lá
  // estava, e muito mais fácil de reter.
  { id: "prazos-divida.contagem-igual", guideId: "prazos-fiscais-divida", statement: "Os dois prazos contam-se da mesma maneira: nos impostos periódicos, a partir do termo do ano em que ocorreu o facto tributário; no IVA e nas retenções a título definitivo, a partir do início do ano civil seguinte. O que difere entre caducidade e prescrição é a duração — quatro anos contra oito — e o que os interrompe.", sourceIds: ["lgt45", "lgt48"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "high", nota: "Art. 45.º, n.º 4 LGT e Art. 48.º, n.º 1 LGT." },
  ...
  // A15 — faltava o caso MAIS PROVÁVEL na vida do leitor deste site, e o
  // único que não exige litígio nenhum: o reembolso de IRS pago fora de
  // prazo. O guia falava só do erro apurado em reclamação ou impugnação, que
  // é o caso raro.
  { id: "juros-indem.reembolso-irs-atrasado", guideId: "juros-indemnizatorios", statement: "São também devidos juros indemnizatórios quando o reembolso de IRS é pago para lá do prazo legal — sem ser preciso reclamar, impugnar nem provar erro de ninguém.", sourceIds: ["lgt43"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 43.º, n.º 3, al. d) LGT. É o caso mais provável na vida do leitor deste site, muito mais do que ganhar uma impugnação." },
  { id: "juros-indem.taxa", guideId: "juros-indemnizatorios", ruleKey: "JUROS_MORA.civis", statement: "Os juros indemnizatórios são contados à taxa dos juros legais — 4%.", sourceIds: ["lgt43", "portaria291_2003"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "high", nota: "Portaria n.º 291/2003. O guia explicava o direito e nunca dizia a que taxa se conta." },
  ...
  // ── plano-prestacoes ─────────────────────────────────────────────────
  { id: "prestacoes.limite-36", guideId: "plano-prestacoes", ruleKey: "PLANO_PRESTACOES.maximoGeral", statement: "O pagamento em prestações é autorizado, em regra, até ao limite máximo de 36 prestações mensais, quando se demonstre que a situação económica do devedor não lhe permite solver a dívida de uma só vez.", sourceIds: ["cppt196"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 196.º, n.º 5 CPPT na numeração vigente — a nota anterior citava o n.º 4. Sinalizada para confirmação na revisão fiscal humana." },
  { id: "prestacoes.alargamento", guideId: "plano-prestacoes", ruleKey: "PLANO_PRESTACOES.alargamentoLimiarUC", statement: "Em caso de notória dificuldade financeira e previsíveis consequências económicas gravosas, o número de prestações pode ser alargado até cinco anos, se a dívida exceder 500 unidades de conta — o equivalente a 51 000 €, à unidade de conta de 102 € em vigor em 2026.", sourceIds: ["cppt196", "oe2026"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 196.º, n.º 6 CPPT na numeração vigente — a nota anterior citava o n.º 5. A conversão para euros vem do motor (`UNIDADE_CONTA`): deixar «500 unidades de conta» sem tradução era pedir ao leitor que fosse procurar noutro lado, que é exatamente o que o resto do catálogo evita." },
  // A6 — a omissão mais séria dos 14 guias, porque não é uma omissão de
  // detalhe: é a omissão de QUEM O GUIA EXCLUI. As dívidas de IVA e de
  // retenções na fonte são precisamente as que um trabalhador independente ou
  // uma pequena sociedade acumulam. Um leitor com 8 000 € de IVA em atraso lia
  // o guia, fazia o pedido, e era indeferido.
  { id: "prestacoes.exclusao-iva-retencoes", guideId: "plano-prestacoes", statement: "O regime geral NÃO abrange as quantias retidas na fonte nem as legalmente repercutidas a terceiros — ou seja, dívidas de IVA e de retenções na fonte ficam de fora. Só excecionalmente podem ser pagas em prestações, mediante demonstração de dificuldade financeira excecional e de consequências económicas gravosas, e com um número de prestações mais curto.", sourceIds: ["cppt196"], appliesFrom: DE, appliesTo: ["TI", "ENI", "COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 196.º, n.os 2 e 3 CPPT. É a exclusão que apanha este público inteiro e que o guia não referia." },
  // A7 — o guia dizia o OPOSTO do que a lei permite: afirmava que o plano
  // «não é automático» e que era preciso demonstrar a situação económica.
  // Para a esmagadora maioria dos leitores — dívidas abaixo de 5 000 € — isso
  // é falso, e desencorajava a única ação que resolveria o problema.
  { id: "prestacoes.plano-oficioso", guideId: "plano-prestacoes", ruleKey: "PLANO_PRESTACOES.automaticoSingulares", statement: "Instaurada a execução por dívida até 5 000 € (pessoa singular) ou 10 000 € (pessoa coletiva), a Autoridade Tributária cria oficiosamente um plano de pagamento em prestações — sem pedido, sem garantia e sem ter de demonstrar seja o que for. O plano fica disponível na área reservada do Portal das Finanças, com a primeira prestação a vencer-se no mês seguinte à notificação.", sourceIds: ["cppt198a"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 198.º-A CPPT. As prestações são mensais, iguais e sucessivas, até 36, e nenhuma pode ser inferior a um quarto da unidade de conta. O plano caduca com a falta de pagamento da primeira prestação ou de três prestações." },
  ...
  // A11 — o título prometia «o que te podem penhorar e o que não podem» e o
  // texto só falava de rendimentos do trabalho. Quem chegava com a conta
  // penhorada — a penhora mais frequente na execução fiscal, e a que acontece
  // sem aviso — saía sem resposta. Alarga-se o texto em vez de estreitar o
  // título.
  { id: "penhora.conta-bancaria", guideId: "penhora-limites", ruleKey: "PENHORA.contaBancariaSalariosMinimos", statement: "Na penhora de saldo bancário é impenhorável o valor global correspondente a um salário mínimo nacional. É a penhora mais frequente na execução fiscal e a mais assustadora, porque acontece sem aviso prévio.", sourceIds: ["cpc738"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 738.º, n.º 6 CPC. Sinalizada para confirmação na revisão fiscal humana." },
  { id: "penhora.alimentos", guideId: "penhora-limites", statement: "Nas execuções por dívida de alimentos o regime dos dois terços não se aplica: a proteção reduz-se ao equivalente à totalidade da pensão social do regime não contributivo.", sourceIds: ["cpc738"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 738.º, n.º 4 CPC. É a exceção que mais surpreende quem conta com a regra geral." },
  { id: "penhora.casa-morada-familia", guideId: "penhora-limites", statement: "A casa de morada de família pode ser penhorada, mas a venda executiva está sujeita a limites próprios — designadamente quando a dívida é de valor reduzido face ao valor do imóvel.", sourceIds: ["cpc738"], appliesFrom: DE, confidence: "review_required", reviewSeverity: "critical", nota: "Art. 751.º, n.os 3 e 4 CPC. Matéria de acompanhamento jurídico: a aplicação concreta depende do valor da dívida, do valor do imóvel e da fase do processo." },
  ...
  // A12 — o guia explicava bem a diferença entre as alíneas e não dizia ao
  // gerente citado o que fazer nos 30 dias seguintes. Faltava o direito com
  // valor imediato: é dinheiro, e depende de um prazo.
  { id: "reversao.isencao-custas-juros", guideId: "reversao-gerentes", statement: "O responsável subsidiário que, citado, pague a dívida DENTRO do prazo de oposição fica isento de custas e dos juros de mora liquidados no processo.", sourceIds: ["lgt23"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 23.º, n.º 5 LGT. É o direito com maior valor imediato de toda a página — e depende de um prazo que não se recupera." },
  { id: "reversao.prazo-oposicao", guideId: "reversao-gerentes", statement: "O prazo de oposição à execução conta-se da citação e é de 30 dias.", sourceIds: ["cppt203"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 203.º CPPT." },
  { id: "reversao.audiencia-previa", guideId: "reversao-gerentes", statement: "A reversão exige audição prévia do responsável subsidiário e depende da fundada insuficiência dos bens penhoráveis da sociedade. Faltando qualquer uma, há fundamento de defesa.", sourceIds: ["lgt23"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 23.º, n.os 2 e 4 LGT." },
  { id: "reversao.prescricao-responsavel", guideId: "reversao-gerentes", statement: "A interrupção da prescrição contra a sociedade só aproveita contra o responsável subsidiário se a citação deste ocorrer dentro do prazo previsto na lei — é um argumento de prescrição que se perde por desconhecimento.", sourceIds: ["lgt48"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 48.º, n.os 2 e 3 LGT." },
  ...
  // ══ Empresas — guias novos (Parte 2 do relatório) ═══════════════════
  //   Todos em `review_required`: vêm de fontes citadas, mas direito
  //   societário e contributivo mudam por diploma. Publicar como verificado
  //   sem revisão humana não seria honesto.

  // ── salario-gerente-ou-dividendos ────────────────────────────────────
  { id: "gerente.salario-e-custo", guideId: "salario-gerente-ou-dividendos", statement: "A remuneração de gerência é gasto dedutível para efeitos de IRC — reduz o lucro tributável e, com ele, o imposto da empresa. O dividendo é distribuição de lucro já tributado: não reduz nada e leva imposto por cima.", sourceIds: ["circ23"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 23.º CIRC. É a assimetria que explica toda a decisão." },
  { id: "gerente.taxa-moe", guideId: "salario-gerente-ou-dividendos", ruleKey: "SS_MOE", statement: "A remuneração dos membros de órgãos estatutários que exercem gerência está sujeita a 34,75% de contribuições: 23,75% da empresa e 11% do próprio.", sourceIds: ["codigoContributivo"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "gerente.base-minima-ias", guideId: "salario-gerente-ou-dividendos", ruleKey: "SS_MOE.baseMinimaIAS", statement: "A base de incidência dos membros de órgãos estatutários tem por limite mínimo o valor do IAS — há contribuições a pagar mesmo com remuneração declarada de zero.", sourceIds: ["codigoContributivo"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "É o custo que quase toda a gente esquece ao dizer «não me pago nada»." },
  { id: "gerente.dividendos-28", guideId: "salario-gerente-ou-dividendos", ruleKey: "DIVIDENDOS_TAXA", statement: "Os lucros colocados à disposição dos sócios estão sujeitos a taxa liberatória de 28%, com opção pelo englobamento.", sourceIds: ["cirs71", "cirs40a"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "gerente.protecao-social", guideId: "salario-gerente-ou-dividendos", statement: "O salário compra mais do que dinheiro: proteção na doença, na parentalidade e formação de carreira contributiva. O dividendo não conta para nenhuma delas.", sourceIds: ["codigoContributivo"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "high" },

  // ── distribuir-lucros ────────────────────────────────────────────────
  { id: "lucros.reserva-legal", guideId: "distribuir-lucros", ruleKey: "RESERVA_LEGAL", statement: "Antes de distribuir, pelo menos 5% do lucro do exercício é destinado à reserva legal, até esta atingir 20% do capital social. Não é opcional.", sourceIds: ["csc"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 218.º CSC." },
  { id: "lucros.englobamento-50", guideId: "distribuir-lucros", ruleKey: "DIV_INCLUSAO_ENGLOBAMENTO", statement: "Optando pelo englobamento, os lucros distribuídos por entidades residentes são considerados em apenas 50% do seu valor. Compensa quando a taxa marginal do sócio é baixa — e obriga a englobar todos os rendimentos da mesma categoria.", sourceIds: ["cirs40a", "cirs71"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 40.º-A CIRS." },
  { id: "lucros.nao-distribuir", guideId: "distribuir-lucros", statement: "Não distribuir é uma decisão legítima, não um adiamento: o lucro fica na empresa tributado apenas em IRC, e reforça os capitais próprios.", sourceIds: ["csc"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "normal" },

  // ── pagamentos-por-conta-irc ─────────────────────────────────────────
  { id: "ppc.tres-pagamentos", guideId: "pagamentos-por-conta-irc", ruleKey: "PAGAMENTOS_CONTA_IRC.meses", statement: "Os pagamentos por conta são três, com vencimento em julho, setembro e até 15 de dezembro do próprio período de tributação.", sourceIds: ["circ104", "circ105"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "ppc.80-ou-95", guideId: "pagamentos-por-conta-irc", ruleKey: "PAGAMENTOS_CONTA_IRC.taxaAte500k", statement: "O total corresponde a 80% da coleta do período anterior líquida de retenções quando o volume de negócios não excedeu 500 000 €, e a 95% quando excedeu.", sourceIds: ["circ105"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "ppc.dispensa-200", guideId: "pagamentos-por-conta-irc", ruleKey: "PAGAMENTOS_CONTA_IRC.dispensaColeta", statement: "Não há lugar a pagamentos por conta quando a coleta do período anterior, líquida de retenções, é igual ou inferior a 200 €.", sourceIds: ["circ105"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "high" },
  { id: "ppc.limitar-terceiro", guideId: "pagamentos-por-conta-irc", ruleKey: "PAGAMENTOS_CONTA_IRC.margemErroTerceiro", statement: "O terceiro pagamento pode ser limitado ou suspenso quando se estime que o já pago cobre o imposto devido. Mas se a estimativa errar por mais de 20%, são devidos juros compensatórios.", sourceIds: ["circ107"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 107.º CIRC. É a armadilha própria desta obrigação." },

  // ── prejuizos-fiscais ────────────────────────────────────────────────
  { id: "prejuizos.sem-limite-temporal", guideId: "prejuizos-fiscais", ruleKey: "PREJUIZOS_FISCAIS.semLimiteTemporal", statement: "Os prejuízos fiscais apurados podem ser deduzidos aos lucros tributáveis de períodos seguintes sem limite temporal.", sourceIds: ["circ52"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 52.º, n.º 1 CIRC. O regime mudou em 2023 — antes eram 12 anos e 70%, que é o que a maioria dos resultados de pesquisa ainda afirma." },
  { id: "prejuizos.teto-65", guideId: "prejuizos-fiscais", ruleKey: "PREJUIZOS_FISCAIS.limitePercentagemLucro", statement: "A dedução em cada período não pode exceder 65% do respetivo lucro tributável; a parte não deduzida por efeito daquele limite mantém-se reportável.", sourceIds: ["circ52"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "prejuizos.titularidade", guideId: "prejuizos-fiscais", ruleKey: "PREJUIZOS_FISCAIS.alteracaoTitularidadeLimite", statement: "A dedução pode cessar quando se verifique a alteração da titularidade de mais de 50% do capital social, salvo nas exceções previstas e mediante autorização.", sourceIds: ["circ52"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "prejuizos.ta-mesmo-com-prejuizo", guideId: "prejuizos-fiscais", statement: "A tributação autónoma paga-se mesmo em ano de prejuízo — e agravada. Ter prejuízo não significa não ter imposto a pagar.", sourceIds: ["circ88"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },

  // ── contratar-primeiro-trabalhador ───────────────────────────────────
  { id: "contratar.custo-real", guideId: "contratar-primeiro-trabalhador", ruleKey: "SS_DEPENDENTE.entidade", statement: "O custo do posto de trabalho é o salário em 14 meses, mais 23,75% de contribuição da entidade empregadora, mais subsídio de refeição, mais o seguro de acidentes de trabalho.", sourceIds: ["codigoContributivo", "lei98_2009"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "contratar.comunicacao-24h", guideId: "contratar-primeiro-trabalhador", statement: "A admissão tem de ser comunicada à Segurança Social nas 24 horas anteriores ao início da produção de efeitos do contrato. Falhar é contraordenação.", sourceIds: ["codigoContributivo"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "contratar.seguro-obrigatorio", guideId: "contratar-primeiro-trabalhador", statement: "O seguro de acidentes de trabalho é obrigatório desde o primeiro dia, sem exceção.", sourceIds: ["lei98_2009"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 79.º da Lei 98/2009." },
  { id: "contratar.forma-escrita", guideId: "contratar-primeiro-trabalhador", statement: "A forma escrita é exigida em contratos a termo, a tempo parcial, em teletrabalho e de muito curta duração, entre outros. A sua falta tem consequências próprias, que variam com o tipo de contrato.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },

  // ── modelo-22-e-ies ──────────────────────────────────────────────────
  { id: "m22.prazo", guideId: "modelo-22-e-ies", ruleKey: "PRAZOS_ANUAIS_EMPRESA.modelo22", statement: "A declaração Modelo 22 é entregue até 31 de maio do ano seguinte ao do período de tributação.", sourceIds: ["circ120"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "ies.prazo", guideId: "modelo-22-e-ies", ruleKey: "PRAZOS_ANUAIS_EMPRESA.ies", statement: "A IES — Informação Empresarial Simplificada — é entregue até 15 de julho do ano seguinte, e cumpre o depósito da prestação de contas.", sourceIds: ["circ120", "csc"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "m22.assinatura-cc", guideId: "modelo-22-e-ies", statement: "As declarações fiscais de uma sociedade são assinadas por Contabilista Certificado inscrito na Ordem — não é o gerente que as pode submeter sozinho.", sourceIds: ["csc", "circ120"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "high" },
  { id: "m22.consequencias", guideId: "modelo-22-e-ies", statement: "Falhar as entregas anuais custa coima — mas custa sobretudo a impossibilidade de obter certidão de não dívida e a perda de benefícios fiscais, que costuma ser mais cara.", sourceIds: ["circ120"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "high" },

  // ── fechar-empresa ───────────────────────────────────────────────────
  { id: "fechar.dissolucao-liquidacao", guideId: "fechar-empresa", statement: "Dissolução e liquidação são duas coisas diferentes: a dissolução abre o processo, a liquidação paga o passivo e partilha o que resta. A sociedade só se extingue com o registo do encerramento da liquidação.", sourceIds: ["csc"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "fechar.cessacao-fiscal", guideId: "fechar-empresa", statement: "Além do registo comercial, é preciso apresentar declaração de cessação nas Finanças e regularizar a situação na Segurança Social.", sourceIds: ["csc", "circ120"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "fechar.responsabilidade-sobrevive", guideId: "fechar-empresa", statement: "A responsabilidade subsidiária dos gerentes por dívidas fiscais da sociedade não desaparece com o encerramento — pode ser efetivada por reversão depois de a empresa estar fechada.", sourceIds: ["lgt24", "lgt23"], appliesFrom: DE, appliesTo: ["COMPANY"], confidence: "review_required", reviewSeverity: "critical", nota: "É a razão pela qual este guia liga diretamente ao da reversão para gerentes." },

  // ══ Conta de outrem — guias novos (Parte 3 do relatório) ════════════

  // ── baixa-medica ─────────────────────────────────────────────────────
  { id: "doenca.periodo-espera", guideId: "baixa-medica", ruleKey: "SUBSIDIO_DOENCA.periodoEsperaDias", statement: "Os primeiros três dias de incapacidade não são subsidiados aos trabalhadores por conta de outrem. Há exceções: internamento hospitalar, tuberculose e doença profissional.", sourceIds: ["dl28_2004", "ssDoenca"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "doenca.prazo-garantia", guideId: "baixa-medica", ruleKey: "SUBSIDIO_DOENCA.prazoGarantiaMeses", statement: "O acesso exige prazo de garantia de seis meses com registo de remunerações, seguidos ou interpolados.", sourceIds: ["dl28_2004", "ssDoenca"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "doenca.indice-profissionalidade", guideId: "baixa-medica", statement: "Exige-se ainda índice de profissionalidade: dias com registo de remunerações nos quatro meses imediatamente anteriores aos dois que precedem o mês da baixa.", sourceIds: ["dl28_2004", "ssDoenca"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },
  { id: "doenca.percentagens", guideId: "baixa-medica", ruleKey: "SUBSIDIO_DOENCA.escaloes", statement: "A percentagem da remuneração de referência é de 55% até 30 dias, 60% de 31 a 90, 70% de 91 a 365 e 75% acima de 365 dias.", sourceIds: ["dl28_2004", "ssDoenca"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "doenca.majoracao", guideId: "baixa-medica", ruleKey: "SUBSIDIO_DOENCA.majoracao", statement: "Há uma majoração de 5 pontos percentuais sobre os escalões de 55% e 60% quando a remuneração de referência não excede 500 € ou quando o agregado tem três ou mais descendentes nas condições legais.", sourceIds: ["dl28_2004", "ssDoenca"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },

  // ── licenca-parental ─────────────────────────────────────────────────
  { id: "parental.modalidades", guideId: "licenca-parental", ruleKey: "LICENCA_PARENTAL.modalidades", statement: "A licença parental inicial pode ser de 120 dias a 100% da remuneração de referência, 150 dias a 80%, 120+30 dias partilhados a 100%, ou 180 dias a 83% com partilha.", sourceIds: ["ct", "dl91_2009", "ssParentalidade"], appliesFrom: DE, appliesTo: ["EMPLOYEE", "TI"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "parental.condicao-partilha", guideId: "licenca-parental", ruleKey: "LICENCA_PARENTAL.partilhaDiasExclusivos", statement: "A partilha exige que cada progenitor goze, em exclusivo, pelo menos 30 dias consecutivos, ou dois períodos de 15 dias consecutivos.", sourceIds: ["ct", "dl91_2009"], appliesFrom: DE, appliesTo: ["EMPLOYEE", "TI"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "parental.licenca-pai", guideId: "licenca-parental", ruleKey: "LICENCA_PARENTAL.paiObrigatoriaDias", statement: "A licença parental exclusiva do pai é de 28 dias obrigatórios, mais 7 dias opcionais gozáveis durante a licença inicial da mãe — e é paga sempre a 100%, qualquer que seja a modalidade escolhida para a licença inicial.", sourceIds: ["ct", "dl91_2009", "ssParentalidade"], appliesFrom: DE, appliesTo: ["EMPLOYEE", "TI"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "parental.escolha-irreversivel", guideId: "licenca-parental", statement: "A modalidade escolhe-se no requerimento e condiciona os dois progenitores. É a decisão financeira mais consequente do primeiro ano de vida de uma criança, e é tomada quase sempre sem ninguém ter feito as contas.", sourceIds: ["dl91_2009"], appliesFrom: DE, appliesTo: ["EMPLOYEE", "TI"], confidence: "review_required", reviewSeverity: "high" },

  // ── subsidio-desemprego ──────────────────────────────────────────────
  { id: "desemprego.prazo-garantia", guideId: "subsidio-desemprego", ruleKey: "SUBSIDIO_DESEMPREGO.prazoGarantiaDias", statement: "O prazo de garantia é de 360 dias com registo de remunerações nos 24 meses imediatamente anteriores à data do desemprego.", sourceIds: ["dl220_2006", "ssDesemprego"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "desemprego.montante", guideId: "subsidio-desemprego", ruleKey: "SUBSIDIO_DESEMPREGO.taxa", statement: "O montante corresponde a 65% da remuneração de referência, com o limite adicional de 75% da remuneração de referência líquida de contribuições e IRS.", sourceIds: ["dl220_2006", "ssDesemprego"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "desemprego.limites-ias", guideId: "subsidio-desemprego", ruleKey: "SUBSIDIO_DESEMPREGO.maximoIAS", statement: "O montante mensal tem um limite máximo de 2,5 × IAS e um limite mínimo indexado ao IAS, que é majorado quando as remunerações registadas não foram inferiores à retribuição mínima mensal garantida.", sourceIds: ["dl220_2006", "ssDesemprego"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "REVISÃO PRIORITÁRIA: fontes secundárias divergem sobre a leitura do limite mínimo (1 × IAS vs. 65% do IAS). O motor guarda as duas variantes e a página não afirma um valor fechado até haver confirmação humana." },
  { id: "desemprego.duracao", guideId: "subsidio-desemprego", ruleKey: "SUBSIDIO_DESEMPREGO.duracaoMaximaDias", statement: "A duração do período de concessão varia com a idade do beneficiário e a carreira contributiva.", sourceIds: ["dl220_2006", "ssDesemprego"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },
  { id: "desemprego.quem-nao-tem", guideId: "subsidio-desemprego", statement: "Quem se despede por iniciativa própria sem justa causa não tem direito a subsídio de desemprego. É a razão número um de indeferimento, e a secção que falta em quase todos os artigos sobre o tema.", sourceIds: ["dl220_2006"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },

  // ── fim-do-contrato ──────────────────────────────────────────────────
  { id: "cessacao.doze-dias", guideId: "fim-do-contrato", ruleKey: "COMPENSACAO_CESSACAO.diasPorAno", statement: "Nos contratos celebrados a partir de 1 de outubro de 2013, a compensação é de 12 dias de retribuição base e diuturnidades por cada ano completo de antiguidade, com proporcional nas frações.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 366.º, n.º 1 CT." },
  { id: "cessacao.tetos", guideId: "fim-do-contrato", ruleKey: "COMPENSACAO_CESSACAO.tetoBaseRMMG", statement: "Há dois tetos: a retribuição base e diuturnidades a considerar não pode exceder 20 × RMMG, e o montante global não pode exceder 12 meses de retribuição base e diuturnidades nem 240 × RMMG.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 366.º, n.º 2 CT." },
  { id: "cessacao.transitorios", guideId: "fim-do-contrato", ruleKey: "COMPENSACAO_CESSACAO.transitorios", statement: "Quem foi admitido antes de novembro de 2011 acumula tranches com contagens diferentes — um mês por ano até outubro de 2012, 20 dias até setembro de 2013, e 12 dias daí em diante. É a razão pela qual dois colegas com a mesma antiguidade recebem valores muito diferentes.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "cessacao.creditos-finais", guideId: "fim-do-contrato", statement: "À compensação somam-se os créditos finais: férias vencidas e não gozadas, proporcionais de férias e de subsídio de férias do ano da cessação, proporcional de subsídio de Natal, e formação contínua não ministrada.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },

  // ── ferias-direitos ──────────────────────────────────────────────────
  { id: "ferias.22-dias", guideId: "ferias-direitos", ruleKey: "FERIAS.diasUteisAno", statement: "O período anual de férias tem a duração mínima de 22 dias úteis.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 238.º, n.º 1 CT." },
  { id: "ferias.ano-admissao", guideId: "ferias-direitos", ruleKey: "FERIAS.anoAdmissaoDiasPorMes", statement: "No ano de admissão, o trabalhador tem direito a dois dias úteis de férias por cada mês de duração do contrato, até 20 dias, gozáveis após seis meses completos de execução do contrato.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 239.º, n.º 1 CT." },
  { id: "ferias.marcacao", guideId: "ferias-direitos", statement: "As férias marcam-se por acordo. Na falta de acordo, cabe ao empregador marcá-las, mas dentro de limites — designadamente o período em que pode fazê-lo e a obrigação de elaborar o mapa de férias.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },
  { id: "ferias.triplo", guideId: "ferias-direitos", ruleKey: "FERIAS.indemnizacaoNaoGozadasFator", statement: "As férias não gozadas por culpa do empregador dão direito ao pagamento do TRIPLO da retribuição correspondente ao período em falta, além do direito a gozá-las no ano seguinte.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 246.º, n.º 1 CT. Direito real, frequentemente violado e raramente reclamado — o mesmo perfil dos 40 € do DL 62/2013." },

  // ── trabalho-noturno-e-turnos ────────────────────────────────────────
  { id: "noturno.periodo", guideId: "trabalho-noturno-e-turnos", ruleKey: "TRABALHO_NOTURNO.horaInicio", statement: "O período de trabalho noturno compreende, em regra, o intervalo entre as 22 horas e as 7 horas do dia seguinte. O IRCT pode fixar outro intervalo, dentro dos limites legais.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 223.º, n.º 1 CT." },
  { id: "noturno.acrescimo-25", guideId: "trabalho-noturno-e-turnos", ruleKey: "TRABALHO_NOTURNO.acrescimo", statement: "O trabalho noturno é pago com acréscimo de 25% relativamente ao pagamento de trabalho equivalente prestado durante o dia, calculado a partir da retribuição horária.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 266.º, n.º 1 CT, com a retribuição horária do Art. 271.º." },
  { id: "noturno.turno-sem-valor-legal", guideId: "trabalho-noturno-e-turnos", statement: "O subsídio de turno não tem valor legal fixo: resulta do instrumento de regulamentação coletiva ou do contrato individual. Aqui o guia ensina onde procurar, não um número.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },
  { id: "noturno.isencao-horario", guideId: "trabalho-noturno-e-turnos", statement: "A isenção de horário de trabalho tem modalidades distintas e uma retribuição mínima correspondente, que varia com a modalidade acordada.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high", nota: "Arts. 218.º a 219.º e 265.º CT." },

  // ── faltas-ao-trabalho ───────────────────────────────────────────────
  { id: "faltas.dois-eixos", guideId: "faltas-ao-trabalho", statement: "«Justificada» e «paga» são dois eixos independentes: há faltas justificadas que não determinam direito a retribuição. Justificar não é o mesmo que não perder.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
  { id: "faltas.desconto", guideId: "faltas-ao-trabalho", ruleKey: "HORARIO_SEMANAL_COMPLETO", statement: "O desconto por falta calcula-se a partir da retribuição horária: retribuição mensal × 12, a dividir por 52 × período normal de trabalho semanal.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical", nota: "Art. 271.º CT." },
  { id: "faltas.subsidio-refeicao", guideId: "faltas-ao-trabalho", ruleKey: "SUBSIDIO_REFEICAO", statement: "O subsídio de refeição compensa uma refeição em dia de trabalho prestado: no dia de falta, perde-se — e é um efeito que quase ninguém antecipa.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "high" },
  { id: "faltas.injustificadas", guideId: "faltas-ao-trabalho", statement: "A falta injustificada, além do desconto na retribuição, pode determinar a perda de dias de férias e do correspondente subsídio, e constitui infração disciplinar.", sourceIds: ["ct"], appliesFrom: DE, appliesTo: ["EMPLOYEE"], confidence: "review_required", reviewSeverity: "critical" },
];
