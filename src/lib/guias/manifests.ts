...
import {
  ...
  Wallet, Calendar, Clock, Building, Scale, Flag, Warning, ChartProjection,
...
// Data de redação dos catorze guias novos (Partes 2 e 3 do relatório).
const NOVOS_REVISTO = "2026-07-29";
...
export const GUIDE_MANIFESTS: GuideManifest[] = [
  // ══ Começar ═════════════════════════════════════════════════════════
  {
    ...
    relatedGuideIds: ["ato-isolado", "regime-simplificado", "iva-recibos-verdes", "seguranca-social", "falsos-recibos-verdes"],
  ...
  },
  {
    ...
    relatedGuideIds: ["contabilidade-organizada", "despesas-dedutiveis", "escaloes-irs", "abrir-atividade", "ifici-nhr"],
  ...
  },
  {
    ...
    relatedGuideIds: ["regime-simplificado", "despesas-dedutiveis", "unipessoal-vs-eni", "iva-de-caixa"],
  ...
  // ══ Faturar ═════════════════════════════════════════════════════════
  {
    ...
    audiences: ["TI", "ENI"], effectiveFrom: DE,
    engineBindings: [],
    relatedGuideIds: ["retencao-na-fonte", "iva-recibos-verdes", "clientes-estrangeiros", "juros-de-mora", "fatura-nao-paga"],
  ...
  },
  {
    ...
    relatedGuideIds: ["clientes-estrangeiros", "fatura-vs-recibo", "abrir-atividade", "calendario-fiscal", "recuperar-iva-incobravel", "iva-de-caixa"],
    relatedToolIds: ["classificar-atividade", "calculadora"],
  ...
  },
  {
    ...
    relatedGuideIds: ["iva-recibos-verdes", "merchant-of-record", "retencao-na-fonte", "fatura-vs-recibo", "ifici-nhr"],
  ...
  // ══ Gerir contribuições ═════════════════════════════════════════════
  {
    ...
    relatedGuideIds: ["acumulacao-emprego", "calendario-fiscal", "cessar-atividade", "abrir-atividade", "falsos-recibos-verdes"],
    relatedToolIds: ["calculadora", "classificar-atividade"],
  ...
  },
  {
    ...
    relatedGuideIds: ["seguranca-social", "retencao-na-fonte", "escaloes-irs", "recibo-vencimento", "falsos-recibos-verdes"],
  ...
  // ══ Preparar o IRS ══════════════════════════════════════════════════
  {
    ...
    relatedGuideIds: ["deducoes-coleta", "tributacao-conjunta", "regime-simplificado", "reembolso-irs", "contestar-liquidacao", "irs-jovem"],
  ...
  },
  {
    ...
    relatedGuideIds: ["escaloes-irs", "tributacao-conjunta", "despesas-dedutiveis", "reembolso-irs", "irs-jovem"],
    relatedToolIds: ["simulador-irs"],
  ...
  },
  {
    ...
    relatedGuideIds: ["escaloes-irs", "deducoes-coleta", "pagamentos-por-conta", "calendario-fiscal", "contestar-liquidacao", "juros-indemnizatorios"],
    relatedToolIds: ["simulador-irs"],
  ...
  // ══ Gerir uma empresa ═══════════════════════════════════════════════
  {
    ...
    relatedGuideIds: ["unipessoal-vs-eni", "irc", "tributacao-autonoma", "contabilidade-organizada", "reversao-gerentes"],
  ...
  },
  {
    ...
    relatedGuideIds: ["abrir-empresa", "irc", "contabilidade-organizada", "regime-simplificado", "reversao-gerentes"],
  ...
  },
  {
    ...
    relatedGuideIds: ["tributacao-autonoma", "abrir-empresa", "unipessoal-vs-eni", "calendario-fiscal", "reversao-gerentes"],
  ...
  // ══ Cumprir prazos ══════════════════════════════════════════════════
  {
    ...
    engineBindings: [],
    relatedGuideIds: ["iva-recibos-verdes", "seguranca-social", "pagamentos-por-conta", "irc", "prazos-fiscais-divida", "plano-prestacoes"],
    relatedToolIds: ["simulador-irs", "calculadora"],
  ...
  //   nenhum guia respondia a "e se for o outro lado a falhar?".
  {
    ...
    engineBindings: ["JUROS_MORA", "INDEMNIZACAO_CUSTOS_COBRANCA", "PRAZO_PAGAMENTO_SUPLETIVO_DIAS"],
  ...
  },
  {
    ...
    audiences: ["TI", "ENI", "COMPANY"], effectiveFrom: DE,
    engineBindings: ["JUROS_MORA", "INDEMNIZACAO_CUSTOS_COBRANCA", "UNIDADE_CONTA"],
  ...
  },
  {
    ...
    audiences: ["TI", "ENI", "COMPANY"], effectiveFrom: DE,
    engineBindings: ["IVA_TAXAS", "IVA_ISENCAO_LIMITE"],
  ...
  },
  {
    ...
    audiences: ["TI", "ENI", "COMPANY", "EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["PLANO_PRESTACOES", "PENHORA", "SMN"],
  ...
  },
  {
    ...
    audiences: ["TI", "ENI", "COMPANY", "EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["PLANO_PRESTACOES", "UNIDADE_CONTA"],
  ...
  },
  {
    ...
    audiences: ["TI", "ENI", "COMPANY"], effectiveFrom: DE,
    engineBindings: ["PLANO_PRESTACOES"],
  ...
  },
  {
    ...
    audiences: ["TI", "EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["SS_DEPENDENTE", "SS_TAXA", "SMN"],
  ...
  // ══ Encerrar ════════════════════════════════════════════════════════
  {
    ...
    relatedGuideIds: ["seguranca-social", "iva-recibos-verdes", "abrir-atividade", "calendario-fiscal", "prazos-fiscais-divida"],
  ...
  // ══ Empresas — o ano de vida da sociedade (Parte 2 do relatório) ════
  //   Havia cinco guias de empresa e cobriam a constituição e a taxa. O que
  //   faltava era o ANO DE VIDA: o que se entrega, quando se paga, o que se
  //   faz com o lucro e com o prejuízo, e como se contrata e se fecha.
  //
  //   Todos nascem em `draft` com revisor por atribuir. É deliberado: o
  //   conteúdo vem de fontes citadas, mas direito societário e laboral
  //   mudam por diploma e por IRCT. Publicar como revisto não seria honesto.
  {
    id: "salario-gerente-ou-dividendos", slug: "salario-gerente-ou-dividendos",
    title: "Salário de gerente ou dividendos?",
    navLabel: "Salário ou dividendos",
    descricao: "As duas formas de tirar dinheiro da empresa custam impostos diferentes — e a melhor mistura muda com o lucro.",
    categoria: "Empresas", hub: "empresa", archetype: "decision", icon: Scale, tempo: 7,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: ["IRC_TAXA_PME", "IRC_TAXA_GERAL", "DIVIDENDOS_TAXA", "SS_MOE", "IAS", "ESCALOES_IRS"],
    relatedGuideIds: ["irc", "distribuir-lucros", "abrir-empresa", "unipessoal-vs-eni"],
    relatedToolIds: ["simulador-empresa", "recibo-vencimento", "comparador"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.remuneration-mix", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Rever a mistura salário/dividendos com a FIZ", exigeRevisaoHumana: true },
    seo: { description: "Salário de gerência ou distribuição de dividendos: o salário é custo e reduz o IRC, os dividendos não; a Segurança Social do gerente e o ponto em que a mistura deixa de compensar.", aliases: ["salário de gerente", "gerente ou dividendos", "quanto pagar a mim próprio", "remuneração de gerência", "retirar dinheiro da empresa"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "distribuir-lucros", slug: "distribuir-lucros",
    title: "Distribuir lucros: liberatória, englobamento ou deixar na empresa",
    navLabel: "Distribuir lucros",
    descricao: "Três destinos para o lucro do ano, com contas e obrigações diferentes.",
    categoria: "Empresas", hub: "empresa", archetype: "decision", icon: Coin, tempo: 6,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: ["DIVIDENDOS_TAXA", "DIV_INCLUSAO_ENGLOBAMENTO", "ESCALOES_IRS", "RESERVA_LEGAL"],
    relatedGuideIds: ["irc", "salario-gerente-ou-dividendos", "escaloes-irs", "prejuizos-fiscais"],
    relatedToolIds: ["simulador-empresa", "simulador-irs"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.profit-distribution", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Preparar a distribuição de lucros com a FIZ" },
    seo: { description: "Dividendos a 28% de taxa liberatória ou englobamento com exclusão de 50%: quando cada via compensa, a reserva legal obrigatória e o que muda se o lucro ficar na empresa.", aliases: ["distribuir dividendos", "taxa liberatória 28%", "englobamento dividendos", "reserva legal", "lucros da empresa"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "pagamentos-por-conta-irc", slug: "pagamentos-por-conta-irc",
    title: "Pagamentos por conta de IRC: o imposto que se paga antes de haver contas",
    navLabel: "Pag. por conta (IRC)",
    descricao: "Três pagamentos em julho, setembro e dezembro, calculados sobre o ano passado — e a armadilha de travar o terceiro.",
    categoria: "Empresas", hub: "prazos", archetype: "status", icon: Calendar, tempo: 5,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: ["PAGAMENTOS_CONTA_IRC"],
    relatedGuideIds: ["irc", "calendario-fiscal", "modelo-22-e-ies", "plano-prestacoes"],
    relatedToolIds: ["simulador-empresa", "calculadora"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.advance-payments", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Calcular os pagamentos por conta com a FIZ" },
    seo: { description: "Pagamentos por conta de IRC: prazos de 31 de julho, 30 de setembro e 15 de dezembro, cálculo a 80% ou 95% da coleta do ano anterior, isenções e o risco de juros compensatórios ao limitar o terceiro.", aliases: ["pagamentos por conta irc", "pagamento por conta empresa", "31 de julho irc", "limitar o terceiro pagamento por conta", "artigo 105 circ"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "prejuizos-fiscais", slug: "prejuizos-fiscais",
    title: "A empresa deu prejuízo. O que fazer com ele",
    navLabel: "Prejuízos fiscais",
    descricao: "O prejuízo de um ano abate ao lucro dos seguintes — sem prazo, mas com um teto anual.",
    categoria: "Empresas", hub: "empresa", archetype: "reference", icon: ChartProjection, tempo: 5,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: ["PREJUIZOS_FISCAIS"],
    relatedGuideIds: ["irc", "tributacao-autonoma", "distribuir-lucros", "modelo-22-e-ies"],
    relatedToolIds: ["simulador-empresa"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.loss-carryforward", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Rever o reporte de prejuízos com a FIZ" },
    seo: { description: "Reporte de prejuízos fiscais em IRC: dedução sem limite temporal desde 2023, teto de 65% do lucro tributável do ano e o efeito nas alterações de titularidade do capital.", aliases: ["prejuízos fiscais", "reportar prejuízo empresa", "dedução de prejuízos irc", "artigo 52 circ", "prejuízo fiscal quantos anos"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "contratar-primeiro-trabalhador", slug: "contratar-primeiro-trabalhador",
    title: "Contratar a primeira pessoa",
    navLabel: "Primeira contratação",
    descricao: "O que custa de verdade, o que tens de comunicar e em que ordem.",
    categoria: "Empresas", hub: "empresa", archetype: "procedure", icon: Briefcase, tempo: 7,
    audiences: ["COMPANY"], effectiveFrom: DE,
  ...
  {
    id: "modelo-22-e-ies", slug: "modelo-22-e-ies",
    title: "Modelo 22 e IES: as duas entregas anuais da empresa",
    navLabel: "Modelo 22 e IES",
    descricao: "Duas declarações, dois prazos, e o que acontece a quem falha.",
    categoria: "Empresas", hub: "prazos", archetype: "status", icon: FileSign, tempo: 5,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: ["PRAZOS_ANUAIS_EMPRESA"],
    relatedGuideIds: ["irc", "pagamentos-por-conta-irc", "calendario-fiscal", "prejuizos-fiscais"],
    relatedToolIds: ["simulador-empresa", "mapa-contabilistas"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.annual-filings", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Preparar as entregas anuais com a FIZ" },
    seo: { description: "Modelo 22 até 31 de maio e IES até 15 de julho: quem entrega, o que consta de cada declaração, quem tem de assinar e as coimas por falta ou atraso.", aliases: ["modelo 22", "ies prazo", "declaração anual empresa", "prestação de contas", "entregar modelo 22"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "fechar-empresa", slug: "fechar-empresa",
    title: "Dissolver e liquidar uma sociedade",
    navLabel: "Fechar a empresa",
    descricao: "Fechar não é deixar de faturar. O que fica por fazer continua a ser teu.",
    categoria: "Empresas", hub: "encerrar", archetype: "procedure", icon: Building, tempo: 7,
    audiences: ["COMPANY"], effectiveFrom: DE,
    engineBindings: [],
    relatedGuideIds: ["cessar-atividade", "reversao-gerentes", "prazos-fiscais-divida", "modelo-22-e-ies"],
    relatedToolIds: ["mapa-contabilistas", "simulador-empresa"],
    fizAction: { topic: "COMPANY", intent: "FIND_ACCOUNTANT", requiredCapability: "company.dissolution", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Planear o encerramento com a FIZ", exigeRevisaoHumana: true },
    seo: { description: "Dissolver e liquidar uma sociedade em Portugal: dissolução na hora, partilha do património, cessação nas Finanças e na Segurança Social, e a responsabilidade que sobrevive ao encerramento.", aliases: ["fechar empresa", "dissolver sociedade", "dissolução na hora", "encerrar lda", "liquidar empresa"], schema: ["Article", "HowTo"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },

  // ══ Conta de outrem — e quando as coisas correm mal ═════════════════
  //   Era a categoria mais fraca do catálogo: três guias contra dezoito dos
  //   independentes, e os três respondiam todos à mesma pergunta — «quanto
  //   me pagam». Nenhum respondia a «e quando as coisas correm mal», que é
  //   quando as pessoas procuram.
  {
    id: "baixa-medica", slug: "baixa-medica",
    title: "Baixa médica: quanto recebes e a partir de quando",
    navLabel: "Baixa médica",
    descricao: "Os três primeiros dias, as quatro percentagens e a conta que quase ninguém sabe fazer.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "calculation", icon: ShieldCheck, tempo: 6,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["SUBSIDIO_DOENCA"],
    relatedGuideIds: ["recibo-vencimento", "licenca-parental", "subsidio-desemprego", "ferias-direitos"],
    relatedToolIds: ["recibo-vencimento", "calculadora"],
    fizAction: { topic: "SOCIAL_SECURITY", intent: "CONFIGURE_SOCIAL_SECURITY", requiredCapability: "benefits.sickness", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Confirmar o subsídio de doença com a FIZ" },
    seo: { description: "Subsídio de doença 2026: período de espera de três dias, prazo de garantia de seis meses, percentagens de 55%, 60%, 70% e 75% da remuneração de referência e como esta se calcula.", aliases: ["baixa médica quanto recebo", "subsídio de doença", "quanto pagam na baixa", "período de espera baixa", "primeiros 3 dias de baixa"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "licenca-parental", slug: "licenca-parental",
    title: "Licença parental: 120, 150 ou 180 dias",
    navLabel: "Licença parental",
    descricao: "As combinações valem percentagens diferentes — e a escolha faz-se antes, não depois.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "decision", icon: User, tempo: 7,
    audiences: ["EMPLOYEE", "TI"], effectiveFrom: DE,
    engineBindings: ["LICENCA_PARENTAL"],
    relatedGuideIds: ["baixa-medica", "recibo-vencimento", "ferias-direitos", "seguranca-social"],
    relatedToolIds: ["recibo-vencimento", "calculadora"],
    fizAction: { topic: "SOCIAL_SECURITY", intent: "CONFIGURE_SOCIAL_SECURITY", requiredCapability: "benefits.parental", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Planear a licença parental com a FIZ" },
    seo: { description: "Licença parental inicial: 120 dias a 100%, 150 dias a 80% ou 100% se partilhada, 180 dias a 83%, mais a licença exclusiva do pai de 28 dias obrigatórios paga sempre a 100%.", aliases: ["licença de maternidade", "licença parental 180 dias", "subsídio parental", "licença de paternidade 28 dias", "partilha da licença parental"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "subsidio-desemprego", slug: "subsidio-desemprego",
    title: "Subsídio de desemprego: quem tem direito, quanto e por quanto tempo",
    navLabel: "Subsídio de desemprego",
    descricao: "360 dias de descontos, 65% da referência, e um teto que apanha quem ganha bem.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "reference", icon: Wallet, tempo: 7,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["SUBSIDIO_DESEMPREGO", "IAS"],
    relatedGuideIds: ["fim-do-contrato", "baixa-medica", "recibo-vencimento", "acumulacao-emprego"],
    relatedToolIds: ["recibo-vencimento", "comparador"],
    fizAction: { topic: "SOCIAL_SECURITY", intent: "CONFIGURE_SOCIAL_SECURITY", requiredCapability: "benefits.unemployment", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Confirmar o direito ao subsídio com a FIZ" },
    seo: { description: "Subsídio de desemprego 2026: prazo de garantia de 360 dias em 24 meses, 65% da remuneração de referência, mínimo de 1 IAS e máximo de 2,5 × IAS, e a duração por idade e carreira contributiva.", aliases: ["subsídio de desemprego", "quanto recebo de desemprego", "fundo de desemprego", "360 dias descontos", "duração subsídio desemprego"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "fim-do-contrato", slug: "fim-do-contrato",
    title: "Quando o contrato acaba: quem deve o quê",
    navLabel: "Fim do contrato",
    descricao: "Compensação, aviso prévio e os créditos finais — três contas que se somam e costumam vir erradas.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "calculation", icon: Scale, tempo: 8,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["COMPENSACAO_CESSACAO", "SMN"],
    relatedGuideIds: ["subsidio-desemprego", "ferias-direitos", "subsidios-ferias-natal", "recibo-vencimento"],
    relatedToolIds: ["recibo-vencimento", "auditoria-recibo"],
    fizAction: { topic: "OTHER", intent: "FIND_ACCOUNTANT", requiredCapability: "employment.termination-review", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Rever as contas finais com a FIZ", exigeRevisaoHumana: true },
    seo: { description: "Contas finais do contrato de trabalho: compensação de 12 dias por ano com os tetos de 20 × RMMG e 12 meses, regimes transitórios por data de admissão, aviso prévio e créditos de férias e subsídios.", aliases: ["indemnização por despedimento", "contas finais trabalho", "quanto recebo se for despedido", "12 dias por ano", "créditos laborais"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "ferias-direitos", slug: "ferias-direitos",
    title: "Férias: quantos dias, quem marca e o que se recebe",
    navLabel: "Férias",
    descricao: "22 dias úteis, uma regra de marcação e uma indemnização que quase ninguém reclama.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "reference", icon: Calendar, tempo: 5,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["FERIAS"],
    relatedGuideIds: ["subsidios-ferias-natal", "faltas-ao-trabalho", "fim-do-contrato", "recibo-vencimento"],
    relatedToolIds: ["recibo-vencimento"],
    fizAction: { topic: "OTHER", intent: "FIND_ACCOUNTANT", requiredCapability: "employment.leave-review", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Esclarecer os direitos de férias com a FIZ" },
    seo: { description: "Direito a férias: 22 dias úteis por ano, regras do ano de admissão, marcação por acordo e na falta dele pelo empregador, e a indemnização do triplo por férias não gozadas por culpa da entidade.", aliases: ["quantos dias de férias", "22 dias úteis", "marcação de férias", "férias não gozadas", "férias no ano de admissão"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "trabalho-noturno-e-turnos", slug: "trabalho-noturno-e-turnos",
    title: "Trabalho noturno, turnos e isenção de horário",
    navLabel: "Noturno e turnos",
    descricao: "Três acréscimos que aparecem no recibo sem explicação — e como confirmar cada um.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "calculation", icon: Clock, tempo: 6,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["HORARIO_SEMANAL_COMPLETO", "TRABALHO_SUPLEMENTAR", "TRABALHO_NOTURNO"],
    relatedGuideIds: ["trabalho-suplementar", "recibo-vencimento", "faltas-ao-trabalho", "subsidios-ferias-natal"],
    relatedToolIds: ["recibo-vencimento", "auditoria-recibo"],
    fizAction: { topic: "OTHER", intent: "FIND_ACCOUNTANT", requiredCapability: "payroll.allowances-review", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Verificar os acréscimos com a FIZ" },
    seo: { description: "Trabalho noturno entre as 22h e as 7h com acréscimo de 25%, subsídio de turno e retribuição da isenção de horário de trabalho: como se calculam e como confirmar no recibo.", aliases: ["acréscimo trabalho noturno", "25% noturno", "subsídio de turno", "isenção de horário quanto paga", "trabalho por turnos direitos"], schema: ["Article"] },
    owner: EQUIPA, reviewer: REVISOR_PENDENTE, lastReviewedAt: NOVOS_REVISTO, status: "draft",
  },
  {
    id: "faltas-ao-trabalho", slug: "faltas-ao-trabalho",
    title: "Faltas: quais se descontam e quais não",
    navLabel: "Faltas",
    descricao: "Justificada não quer dizer paga. São dois eixos diferentes e é aí que se perde dinheiro.",
    categoria: "Conta de outrem", hub: "conta-outrem", archetype: "reference", icon: Warning, tempo: 5,
    audiences: ["EMPLOYEE"], effectiveFrom: DE,
    engineBindings: ["HORARIO_SEMANAL_COMPLETO", "SUBSIDIO_REFEICAO"],
    relatedGuideIds: ["ferias-direitos", "baixa-medica", "recibo-vencimento", "trabalho-noturno-e-turnos"],
    relatedToolIds: ["recibo-vencimento", "auditoria-recibo"],
    fizAction: { topic: "OTHER", intent: "FIND_ACCOUNTANT", requiredCapability: "payroll.absences-review", dataPolicy: "CONSENTED_HANDOFF", fallbackLabel: "Rever os descontos por faltas com a FIZ" },
