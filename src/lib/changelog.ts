...
export const CHANGELOG: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "O quiz público deixou de entregar no HTML estruturado as respostas certas e as explicações. A página de amostra mostra apenas uma seleção pequena de enunciados; a migração integral do banco de perguntas para respostas servidas pelo servidor fica documentada como a próxima fronteira crítica.",
