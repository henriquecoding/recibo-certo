...
const NOVAS_ENTRADAS: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "O cabeçalho do computador passou a ter três linhas, cada uma com um trabalho só: em cima a marca, os atalhos para Guias, Quiz, Contabilistas, Planos e Sugestões, e a conta; no meio a navegação; em baixo a pesquisa. As três têm a mesma largura e as mesmas margens — antes eram duas, com tudo a disputar a primeira, e num ecrã largo a navegação ficava colada ao logótipo e desalinhada da barra de pesquisa.",
      "E o cabeçalho deixou de mudar quando rolas a página. Nada encolhe, nada muda de sítio, nada desaparece: é a mesma coisa no topo e a meio de um guia. Custa uns pixels a mais de altura e poupa a sensação de que algo se partiu.",
      "A navegação passou a ter o mesmo desenho dos controlos do resto do produto: uma bandeja com o sítio onde estás em relevo, do tamanho do que leva dentro em vez de esticada de margem a margem. Continua a ler-se em preto e branco e sem sombras — o rótulo aceso é mais escuro do que os outros, não só de outra cor.",
      "O vidro do cabeçalho passou para o sítio certo. Estava na barra de navegação, onde não passa nada por baixo — era um desenho de vidro a custar trabalho ao computador para não se ver nada. Agora é o cabeçalho que o tem, com fundo sólido onde o browser não o suporta e para quem pediu menos transparência no sistema.",
