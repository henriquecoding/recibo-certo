...
const NOVAS_ENTRADAS: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "Dessas três, só a primeira fica sempre à vista. O cabeçalho abre recolhido — uma linha — e tem por baixo uma lingueta que revela a navegação e a pesquisa. Três linhas permanentes gastavam 230 px de ecrã antes de a página sequer começar; recolhido são 114. A escolha fica guardada no aparelho, e o atalho de pesquisa (⌘K ou Ctrl+K) abre-o sozinho para escreveres, mesmo que o tenhas fechado.",
      "E o cabeçalho continua a não mudar quando rolas a página. Nada encolhe, nada muda de sítio, nada desaparece: recolhido ou aberto, é a mesma coisa no topo e a meio de um guia. Só muda de altura quando és tu a pedir.",
