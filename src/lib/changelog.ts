...
const NOVAS_ENTRADAS: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "O cabeçalho do computador passou a ter três linhas, cada uma com um trabalho só: em cima a marca, os atalhos para Guias, Quiz, Contabilistas, Planos e Sugestões, e a conta; no meio a navegação; em baixo a pesquisa. Antes eram duas, com tudo a disputar a primeira — e num ecrã largo a navegação ficava colada ao logótipo e desalinhada da barra de pesquisa. Agora a navegação e a pesquisa partilham a mesma largura e o mesmo eixo.",
      "Ao rolar a página, a navegação e a pesquisa ficam onde estão — nem uma nem outra muda de sítio ou de tamanho. O que recolhe é a primeira linha, e nada dela se perde: as secções, a conta e o «Começar» estão também dentro do «Menu», que fica sempre à vista.",
