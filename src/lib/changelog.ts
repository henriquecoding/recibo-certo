...
export const CHANGELOG: EntradaChangelog[] = [
  {
    version: "2.30.0",
    data: "2026-08-10",
    titulo: "Este painel, reorganizado — por mês, e a abrir num instante",
    itens: [
      "Eram 175 versões numa tira única, todas abertas ao mesmo tempo: 760 pontos de texto seguidos, sem uma única referência entre o que mudou hoje e o que mudou em junho. Agora a história está agrupada POR MÊS, com o nome do mês colado ao topo enquanto rolas, para nunca se perder o sítio.",
      ...
      "Cada versão antiga é uma linha fechada que abre quando a tocas. O painel passa a desenhar 175 linhas simples em vez de 760 parágrafos.",
      "E abre muito mais depressa. O texto de todas as versões são 186 KB, e vinham como JavaScript: o telemóvel tinha de os descarregar, interpretar e executar antes de mostrar uma linha — 58 KB comprimidos, só para ler o que mudou esta semana. Agora os títulos de todas as versões e o corpo da entrada nova chegam num ficheiro de dados de 6 KB, e o resto do texto só é buscado se abrires uma entrada antiga (e já vai a caminho quando passas o dedo ou o cursor por cima dela).",
      "O que se escreve continua a escrever-se no mesmo sítio de sempre: os ficheiros que o painel lê são gerados a partir dele em cada compilação, e há uma verificação que trava a integração se ficarem para trás.",
