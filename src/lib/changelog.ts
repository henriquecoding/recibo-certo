...
const NOVAS_ENTRADAS: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "E o cartão do parceiro deixa de ser um painel amarelo a toda a largura no fim de um artigo. Passa a assentar na superfície normal do site, com o mesmo logótipo, o mesmo destino, o mesmo rótulo e a mesma divulgação da comissão — nada disso muda, e nos guias de execução continua a ser ele a liderar. O que muda é o volume: com duas saídas no fim da página, a mais berrante ganhava sempre, e quem escolhia deixava de ser a tua situação para passar a ser a cor. Num guia sobre penhoras ou execuções fiscais, um painel de marca a gritar era, além do mais, a última coisa de que alguém precisa.",
    ],
  },
  {
    version: "2.164.0",
  ...
  },
  {
    ...
    itens: [
      "A página inicial terminava num cartaz de publicidade encostado ao fundo, sem uma linha a explicar porque é que ali estava — e no fim da página, depois das perguntas frequentes e das fontes, quase ninguém lá chegava. Ganhou uma secção, «O passo seguinte», e mudou de sítio: fica agora a meio da leitura, logo a seguir à parte que já fala do que fazer depois, nas cinco entradas da página inicial.",
      "A secção diz quem faz o quê: duas faixas nossas — onde acabamos nós, e quando é caso para um contabilista — e só depois o cartaz do parceiro, na faixa que é dele.",
  ...
  },
  {
    ...
    itens: [
      ...
      "A própria entrada do planeador deixou de repetir o cabeçalho e o cartão genéricos das ferramentas: abre agora como um estúdio em verde profundo, apresenta as três respostas que a decisão vai produzir e reúne duração, acesso, privacidade e referência fiscal na mesma composição. As etapas começam logo abaixo, com resumo fixo no ecrã largo e compacto no telemóvel; a ação principal cabe inteira a 320 pixéis.",
  ...
  },
  {
    ...
    itens: [
      "Desde 1 de julho de 2026, uma empreitada de construção ou reabilitação de habitação deixou de ser tributada a 23% e passou à taxa reduzida de 6% no continente (4% nas regiões autónomas). É a nova verba 2.42 da lista I, criada pelo Decreto-Lei n.º 97/2026. O site continuava a mostrar só a taxa normal.",
      "A redução tem limites, e não são redondos: o imóvel tem de ficar até 660 982 € de preço de venda ou 2300 € de renda mensal. Nenhum dos dois é um número escolhido — o primeiro é o 2.º escalão da tabela do IMT, o segundo é 2,5 vezes o salário mínimo. Ficam ligados a essas duas fontes, para subirem sozinhos quando o Orçamento lhes mexer, em vez de envelhecerem calados.",
      "Na mesma data mudou quem entrega o imposto ao Estado nas obras. Até aqui, a autoliquidação na construção civil só se aplicava se o cliente tivesse direito a deduzir IVA; um promotor que só vende habitação — operação isenta — recebia fatura com imposto. Agora, tratando-se de uma empreitada da verba 2.42, a fatura sai sem imposto mesmo para esse cliente.",
      "Para quem emite, a pergunta deixou de ser uma e passou a ser duas: já não basta saber se o cliente deduz — se não deduzir, falta saber se a obra cabe na verba 2.42. O guia da autoliquidação passa a explicar os dois casos e a dizer qual é qual.",
      "A taxa reduzida pode ser retirada depois da obra estar feita, e isso é a parte que apanha as pessoas: a venda tem de ocorrer em 24 meses, o título tem de mencionar a verba, e no arrendamento o imóvel tem de estar arrendado 36 meses nos primeiros cinco anos. Falhando qualquer uma, o imposto é devolvido ao Estado com juros. Os prazos passam todos a estar escritos no guia.",
      "Verificámos também o que NÃO mudou, para não andar a corrigir o que estava certo: as taxas de IVA de 2026 e o regime de isenção do artigo 53.º (15 000 €, com o limite transfronteiriço de 100 000 € na União) mantêm-se, e já estavam corretos no site.",
    ],
  },
  {
    version: "2.143.0",
  ...
  },
  {
    ...
    itens: [
      "A área de Salário passou a perguntar se queres conferir o teu recibo ou planear uma contratação. O percurso do trabalhador mantém o palco existente; o percurso patronal abre uma demonstração própria e leva ao novo Planeador de Contratação.",
      "O planeador transforma orçamento, líquido pretendido, proposta conhecida ou capacidade necessária numa decisão completa: custo total, composição do pacote, calendário do primeiro ano, custos do posto, linha de equilíbrio e comparação entre propostas.",
      "A homepage otimizada e as correções mobile foram integradas numa só versão. Cada leitura continua a carregar apenas quando é pedida, e a interface mantém o piso tipográfico, os alvos táteis e a contenção horizontal a 320 e 360 px.",
      "Os cenários de contratação só são guardados depois de confirmação explícita. O cálculo anónimo permanece local e não inicializa a ligação à base de dados.",
    ],
  },
  {
    version: "2.135.0",
    ...
    itens: [
      ...
      "A página deixou de saltar por baixo dos olhos. Cerca de dois segundos e meio depois de abrires uma leitura, a demonstração recomeça do princípio — e o cabeçalho dela mudava de tamanho nesse instante: a frase que descreve o passo às vezes ocupa duas linhas e às vezes uma, e os botões passam de um para dois. Quatro das cinco leituras davam um salto de 44 pixels, com a pessoa já a ler. A caixa passa a reservar sempre o maior dos casos, portanto o texto muda e nada se desloca.",
    ],
  },
  {
    version: "2.134.1",
