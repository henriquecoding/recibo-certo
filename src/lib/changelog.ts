...
const NOVAS_ENTRADAS: EntradaChangelog[] = [
  {
    ...
    itens: [
      ...
      "O cabeçalho do computador passou a ter três linhas, cada uma com um trabalho só: a marca e a conta em cima, a navegação a seguir, a pesquisa por baixo. Antes eram duas, com tudo a disputar a primeira — e num ecrã largo a navegação ficava colada ao logótipo e desalinhada da barra de pesquisa que tem logo por baixo. Agora as duas partilham a mesma largura e o mesmo eixo.",
      "E a navegação deixou de desaparecer quando rolas a página. Só a linha da pesquisa recolhe, e a barra sobe para junto da marca: para mudares de sítio já não tens de voltar ao topo.",
