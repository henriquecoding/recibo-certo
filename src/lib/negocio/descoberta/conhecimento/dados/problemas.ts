...
export const PROBLEMAS: readonly Problema[] = Object.freeze([
  ...
  },
  {
    ...
    publicos: ["turistas"],
    baseDeClientes: { tipo: "nao-contavel", porque: "Quem paga é o visitante, e um visitante não é residente nem empresa. Nenhuma fonte pública o conta por concelho — as dormidas contam noites, não compradores de um passeio." },
    mercado: "b2c",
  ...
  },
  {
    ...
    publicos: ["turistas", "empresas"],
    baseDeClientes: { tipo: "empresas", cae: ["01", "11"], ressalva: "A divisão 01 é a agricultura inteira e a 11 são todas as bebidas; só uma fração tem prova aberta ao público." },
    mercado: "b2b",
  ...
  // ── EMPRESAS ──────────────────────────────────────────────────────
  {
    ...
    publicos: ["empresas"],
    baseDeClientes: { tipo: "empresas", cae: ["TOT"], ressalva: "É o total de empresas do concelho: inclui as que já têm processos arrumados." },
    mercado: "b2b",
  ...
  },
  {
    ...
    publicos: ["empresas"],
    baseDeClientes: { tipo: "empresas", cae: ["TOT"], ressalva: "É o total de empresas do concelho, e só uma parte tem equipa comercial própria." },
    mercado: "b2b",
  ...
  },
  {
    ...
    baseDeClientes: { tipo: "empresas", cae: ["TOT"], ressalva: "É o total de empresas do concelho; só uma fração tem capacidade de entrega para concursos públicos." },
    mercado: "b2g",
  ...
  },
  {
    ...
    publicos: ["empresas"],
    baseDeClientes: { tipo: "empresas", cae: ["TOT"], ressalva: "É o total de empresas do concelho, e só as que mudam de sistema num dado ano têm o problema." },
    mercado: "b2b",
  ...
  },
  {
    ...
    publicos: ["empresas", "turistas"],
    baseDeClientes: { tipo: "empresas", cae: ["55", "68"], ressalva: "A divisão 68 são as atividades imobiliárias inteiras, muito para além de quem gere espaços que mudam de ocupante." },
    mercado: "b2b",
  ...
  },
  {
    ...
    publicos: ["empresas"],
    baseDeClientes: { tipo: "nao-contavel", porque: "Os clientes são pequenas unidades de produção, espalhadas por vinte e quatro divisões da indústria transformadora. Contar só algumas daria uma base parcial com ar de total, e contar todas apanharia fábricas que têm manutenção própria." },
    mercado: "b2b",
  ...
  },
  {
    ...
    publicos: ["profissionais", "empresas"],
    baseDeClientes: { tipo: "nao-contavel", porque: "Quem já ensina ao vivo raramente está registado como empresa de educação. A divisão 85 contaria escolas e centros de formação, não formadores independentes — que são exatamente estes clientes." },
    mercado: "b2b",
    gatilhos: ["digitalizacao", "crescimento"],
  ...
  [
    ...new Set(
      PROBLEMAS.flatMap((problema) =>
        problema.baseDeClientes.tipo === "empresas" ? problema.baseDeClientes.cae : [],
      ),
    ),
  ].sort(),
);
