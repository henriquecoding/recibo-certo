...
function MetodoDescobrir() {
  return (
    <section className="grain bg-sand px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="metodo-descobrir-titulo">
...
function PercursoDescobrir() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="percurso-descobrir-titulo">
      <div className="mx-auto max-w-6xl">
...
function FontesDescobrir() {
  return (
    <section className="grain bg-sand px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="fontes-descobrir-titulo">
...
function FAQDescobrir() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="faq-descobrir-titulo">
