                    ...
                    {temTestamento && (
                      <div className="rounded-2xl border border-brand/20 bg-brand-light/20 p-4 dark:bg-brand/5">
                        ...
                        {resultado.partilha.configLegitima && (
                          <div className="mt-4 rounded-xl border border-brand/20 bg-brand-light/25 p-3.5 dark:border-brand/20 dark:bg-brand/5">
                              ...
                              {[0, 25, 50, 75, 100].map((p) => {
                                ...
                                return (
                                  <button
                                    ...
                                    type="button"
                                    aria-pressed={ativo}
                                    onClick={() => setFracaoDisponivel(p / 100)}
                            ...
                            <input
                              ...
                              aria-label="Ajuste fino da parte da quota disponível deixada"
                              className="mt-3 h-1.5 w-full cursor-pointer accent-brand"
                            />
