...
function MetodoPreco() {
  return (
    <section className="grain bg-sand px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="metodo-preco-titulo">
...
function PercursoPreco() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="percurso-preco-titulo">
      <div className="mx-auto max-w-6xl">
...
function FontesPreco() {
  return (
    <section className="grain bg-sand px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="fontes-preco-titulo">
...
function FAQPreco() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-24" aria-labelledby="faq-preco-titulo">
