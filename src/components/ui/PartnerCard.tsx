...
export default function PartnerCard({
  ...
  return (
    <div
      ...
      className="rounded-4xl border border-stone-100 bg-white p-5 shadow-card dark:bg-stone-900 dark:border-stone-800"
    >
      <div className="mb-3 flex items-start justify-between gap-2">
        <div className="flex items-center gap-3">
          <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl bg-stone-50 text-stone-500 dark:bg-stone-800 dark:text-stone-400">
            <Icon size={19} />
          </span>
          <div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            className="flex h-6 w-6 items-center justify-center rounded-lg text-stone-300 transition-colors hover:bg-stone-100 hover:text-stone-500 dark:hover:bg-stone-800 dark:hover:text-stone-400"
          >
      ...
      <p className="text-xs leading-relaxed text-stone-500 dark:text-stone-400">{partner.descricao}</p>
