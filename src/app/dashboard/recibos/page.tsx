...
export default function RecibosPage() {
  ...
  const campo = "w-full px-3.5 py-2.5 text-[16px] text-stone-800 bg-stone-50 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand transition-all";
        ...
        <form onSubmit={submit} className="p-6 rounded-2xl bg-white border border-stone-100 space-y-4">
          ...
          <div>
            <div className="mb-1.5 flex items-center gap-1.5">
              <span className="text-xs font-medium uppercase tracking-wider text-stone-500">Tipo de atividade</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <div className="mb-1.5 flex items-center gap-1.5">
                <label htmlFor="iva" className="text-xs font-medium uppercase tracking-wider text-stone-500">IVA</label>
          ...
          <div>
            <div className="mb-1.5 flex items-center gap-1.5">
              <label htmlFor="baseSS" className="text-xs font-medium uppercase tracking-wider text-stone-500">Natureza (Seg. Social)</label>
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 p-3 rounded-xl border text-left transition-all ${
              form.dispensaRetencao ? "border-brand bg-brand-light" : "border-stone-200 bg-stone-50"
            }`}
          >
            <span className={`w-5 h-5 rounded-md border-2 flex items-center justify-center flex-shrink-0 ${form.dispensaRetencao ? "bg-brand border-brand text-white" : "border-stone-300 text-transparent"}`}>
              <Check size={12} />
            </span>
            <span className={`text-sm font-medium ${form.dispensaRetencao ? "text-brand-dark" : "text-stone-600"}`}>
          ...
          <div className="flex gap-2">
            ...
            {editId && (
              <button
                ...
                className="rounded-xl border border-stone-200 px-4 py-3 text-sm font-semibold text-stone-600 transition-all hover:border-stone-300"
              >
                Cancelar
              </button>
            )}
