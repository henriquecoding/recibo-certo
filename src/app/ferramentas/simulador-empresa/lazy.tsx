...
const EmpresaDynamic = dynamic(() => import("@/components/simulador/ModoGuiadoEmpresa"), {
  ssr: false,
  loading: () => <Esqueleto />,
});

export default function ModoGuiadoEmpresaLazy() {
  return (
    <ErrorBoundary etiqueta="o simulador de empresa">
      <EmpresaDynamic />
    </ErrorBoundary>
  );
}
