...
const HerancaDynamic = dynamic(() => import("@/components/SimuladorHeranca"), {
  ssr: false,
  loading: () => <Esqueleto />,
});

export default function SimuladorHerancaLazy() {
  return (
    <ErrorBoundary etiqueta="o simulador de heranças">
      <HerancaDynamic />
    </ErrorBoundary>
  );
}
