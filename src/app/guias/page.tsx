...
const FERRAMENTAS = [
  { label: "Simuladores", desc: "Recibos verdes, vencimento e empresa — o teu líquido real, com as taxas oficiais de 2026.", href: "/ferramentas", icon: Briefcase },
    ...
    <>
      ...
      <section className="mt-12 rounded-4xl border border-stone-200/70 bg-white p-6 shadow-card dark:border-stone-700 dark:bg-stone-900 sm:p-8">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <Link href="/ferramentas" className="inline-flex items-center gap-1.5 rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-white shadow-card transition-colors hover:bg-brand-dark">
